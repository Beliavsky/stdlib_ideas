...
contains
! adapted from Fortran code at https://rosettacode.org/wiki/Kahan_summation
function sumc(a) result(asum)	! add elements of the array, using limited precision, via compensated summation
